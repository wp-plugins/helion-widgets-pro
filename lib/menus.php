...
informacji znajdziesz na stronie <a href="http://program-partnerski.helion.pl" target="_blank">http://program-partnerski.helion.pl</a></strong>.</p>
	...
	<table class="form-table">
		...
		<tr valign="top">
			...
			<td><span style="font-weight: bold; color: red;">funkcja shell_exec() jest niedostępna</span> (<em>Twój hosting wprowadził ograniczenia, przez co wtyczka może nie działać poprawnie.</em>)</td>
		</tr>
		<?php } ?>
		<tr valign="top">
